    ...
    <div class="bg-white border-2 rounded-xl border-gray px-5 py-5 mt-2">
        <div class="flex flex-wrap">
            ...
            <div class="w-full">  
                ...
                <div class="mt-5">
                    <p>
                        Seu papel no sistema será corrigir os trabalhos de seus alunos e aprová-los para que o responsável do evento visualize os trabalhos. <br><br>
                        Clique no botão asseguir para ver os trabalhos:
                    </p>
                </div>
                <div class="mt-5">
                    <a class="px-2 sm:px-8 md:px-12 mt-1 mb-1 sm:mt-0 py-2 mr-2 text-sm text-center text-white bg-gray-800 rounded-md focus:outline-none font-bold" href="#" v-on:click="hrefSubmissions">
                        <font-awesome-icon :icon="['fas', 'eye']" /> &nbsp; Ver trabalhos pendentes
                    </a>
                </div>
            </div>   
        </div>
